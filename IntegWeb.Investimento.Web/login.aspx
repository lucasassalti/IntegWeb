<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="IntegWeb.Investimento.Web.login" %>
...
<head>
    ...
    <title>FUNCESP - Investimento</title>
            ...
            <div id="main">
                <div class="full_w">
                    <form id="Form1" runat="server">
                      <center><img src="img/bg_logo.png" style="height: 78px; width: 93px;" /><br /><h2>InvestWeb</h2></center>  
                        <%--<h1 class="tituloLogin">InvestWeb</h1>--%>
