...
namespace IntegWeb.Financeira.Aplicacao.ENTITY
{
    ...
    public partial class HIST_CADASTRO_COMPLEM_FSS
    {
        public int NUM_SQNCL_HSCDCP { get; set; }
        public string TIP_PROCES_TPPCCD { get; set; }
        ...
        public Nullable<System.DateTime> DAT_INIVIG_HSCDCP { get; set; }
        public Nullable<System.DateTime> DAT_FIMVIG_HSCDCP { get; set; }
        public Nullable<short> COD_BANCO { get; set; }
        public Nullable<int> COD_AGBCO { get; set; }
        public string NUM_CTCOR_HSCDCP { get; set; }
        public string TIP_CTCOR_HSCDCP { get; set; }
