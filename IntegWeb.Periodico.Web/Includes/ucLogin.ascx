<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucLogin.ascx.cs" Inherits="IntegWeb.Periodico.Web.Includes.ucLogin" %>
...
<%--        <img src="img/bg_logo.png" style="float: left; height: 68px; width: 83px;" />--%>
        <h1 class="tituloBranco">Controle Periódico
        </h1>
        <h3>
    ...
    <div class="right">
        ...
        <div class="align-right">
            <p>
                ...
                </strong>[<asp:LinkButton ID="lnkSair" runat="server" OnClick="lnkSair_Click" CausesValidation="false">Sair</asp:LinkButton>]
            </p>
...
<div runat="server" id="divNLogado">
    ...
    <asp:TextBox ID="txtLogin" runat="server" CssClass="text inputLogin"></asp:TextBox>
