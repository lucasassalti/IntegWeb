...
{
    public class ItemOrcDal : ItemOrc
    {
        protected DataTable SelectData()
        {
            ...
            try
            {
                ...
                objConexao.AdicionarParametro("P_IDC_CONVENIO_ESP", idc_convenio_esp);
                objConexao.AdicionarParametro("P_COD_CLASSE",cod_classe);
                OracleDataAdapter adpt = objConexao.ExecutarAdapter("SAU_PKG_ORCITEM.LISTAR_DADOS");
        ...
        protected DataTable SelectCombo()
        {
            DataTable dt = new DataTable();
            ConexaoOracle objConexao = new ConexaoOracle();
            try
            {
                ...
                OracleDataAdapter adpt = objConexao.ExecutarAdapter("SAU_PKG_ORCITEM.LISTAR_COMBO");
        ...
        protected bool UpdateData(out string mensagem)
        {
            ...
            try
            {
                ...
                objConexao.AdicionarParametro("P_IDC_CONVENIO_ESP", idc_convenio_esp);
                objConexao.AdicionarParametro("P_COD_CLASSE", cod_classe);
                objConexao.AdicionarParametro("P_DES_CLASSE",des_classe);
                objConexao.AdicionarParametro("P_COD_EMPRS", cod_emprs);
                
   
                mensagem = "Registro Atualizado com Sucesso";
                return objConexao.ExecutarNonQuery("SAU_PKG_ORCITEM.ATUALIZAR_DADOS");
            }
            catch (Exception ex)
            {
