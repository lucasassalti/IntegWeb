...
{
    public class ItemOrcIRDAL : ItemOrcIR
    {
        protected DataTable SelectData()
        {
            ...
            try
            {
                ...
                OracleDataAdapter adpt = objConexao.ExecutarAdapter("SAU_PKG_ORCIR.LISTAR_DADOS");
        ...
        protected bool UpdateData(out string mensagem)
        {
            ...
            try
            {
                ...
                return objConexao.ExecutarNonQuery("SAU_PKG_ORCIR.ATUALIZAR_DADOS");
            }
            catch (Exception ex)
            {
