...
namespace IntegWeb.Saude.Aplicacao.ENTITY
{
    ...
    public partial class EMPREGADO
    {
        ...
        public Nullable<long> NUM_RGTRORPTANT_EMPRG { get; set; }
        ...
        public Nullable<long> PESCODPESSOA { get; set; }
        ...
        public string EMPRG_COD_POSTAL_EXT { get; set; }
        public string EMPRG_DES_PRVNC_EST { get; set; }
        public string EMPRGNOMEASSOCIADO { get; set; }
        public Nullable<long> EMPRGNUMASSOCIADO { get; set; }
        public string EMPRGCODASSOCIADO { get; set; }
        public Nullable<short> EMPRGGRDPASSOCIADO { get; set; }
        public Nullable<long> NUM_CPF_CJGE_EMPRG { get; set; }
        public string COD_SEXO_CJGE_EMPRG { get; set; }
        public Nullable<System.DateTime> DAT_NASC_CJGE_EMPRG { get; set; }
        public string EMPRGCODVERIFICADO { get; set; }
        public Nullable<System.DateTime> EMPRGDATVERIFICACAO { get; set; }
        public Nullable<short> TPGCODTIPOPAGTO { get; set; }
        public string EMPRGCODPOSSUIDEP { get; set; }
