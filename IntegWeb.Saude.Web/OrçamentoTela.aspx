<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="OrçamentoTela.aspx.cs" Inherits="IntegWeb.Saude.Web.OrçamentoTela" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upOrcamento">
        <ContentTemplate>

            <asp:ValidationSummary ID="vsOrcamento" runat="server" ForeColor="Red" ShowMessageBox="true"
                ShowSummary="false" />
            <div class="full_w">

                <div class="tabelaPagina">

                    <h1>Centro de Custo / Orçamento</h1>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>Código da Natureza</td>
                            <td>
                                <asp:TextBox onkeypress="mascara(this, soNumeros)" ID="txtCodNatureza" runat="server"></asp:TextBox></td>
                        </tr>

                        <tr>
                            <td>Código da Classe</td>
                            <td>
                                <asp:TextBox onkeypress="mascara(this, soNumeros)" ID="txtCodClasse" runat="server"></asp:TextBox></td>
                        </tr>

                        <tr>
                            <td>Selecione o tipo de Convênio</td>
                            <td>
                                <asp:DropDownList ID="drpTipoConvenio" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:GridView DataKeyNames="COD_EMPRS, COD_PLANO, COD_NATUREZA_CT, IDC_CONVENIO_ESP, COD_CLASSE" OnRowCancelingEdit="grdOrcamento_RowCancelingEdit" OnRowEditing="grdOrcamento_RowEditing" OnRowUpdating="grdOrcamento_RowUpdating" AllowPaging="true"
                        AutoGenerateColumns="False" EmptyDataText="A consulta não retornou registros" CssClass="Table" ClientIDMode="Static" ID="grdOrcamento" runat="server" OnPageIndexChanging="grdOrcamento_PageIndexChanging" PageSize="16">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="COD_PLANO_CT" ItemStyle-HorizontalAlign="Center">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtCodPlanoCt" runat="server" Text='<%# Bind("COD_PLANO_CT") %>' Width="90px"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="DES_CLASSE">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDesClasse" runat="server" Text='<%# Bind("DES_CLASSE") %>' Width="90px"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" TabIndex="0" Text="Obrigatório!" ID="RequiredFieldValidator30" ControlToValidate="txtDesClasse" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblDesClasse" runat="server" Text='<%# Bind("DES_CLASSE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
