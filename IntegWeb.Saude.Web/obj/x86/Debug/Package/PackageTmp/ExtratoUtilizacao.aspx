<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Principal.Master" CodeBehind="ExtratoUtilizacao.aspx.cs" Inherits="IntegWeb.Saude.Web.ExtUtilizacao" %>
                    ...
                    <div class="tabelaPagina">
                        ...
                        <asp:GridView ID="grdExtratoUtilizacao" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="data_emissao" HeaderText="Data de Emissão" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" />
                                ...
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="btDetalhes" CausesValidation="false" CssClass="button" runat="server" Text="Visualizar" CommandName="Visualizar" CommandArgument='<%# txtCodEmpresa.Text + "," + txtCodMatricula.Text + "," + ddlRepresentante.SelectedValue + "," + txtDtIni.Text + "," + txtDtFim.Text + "," + Eval("periodo_desconto") + "," + Eval("data_emissao") %>' />
