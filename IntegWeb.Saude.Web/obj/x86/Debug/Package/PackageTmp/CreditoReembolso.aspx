<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Principal.Master" CodeBehind="CreditoReembolso.aspx.cs" Inherits="IntegWeb.Saude.Web.CredReembolso" %>
                        ...
                        <asp:GridView ID="grdCreditoReembolso" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="btDetalhes" CausesValidation="false" CssClass="button" runat="server" Text="Visualizar" CommandName="Visualizar" CommandArgument='<%# txtCodEmpresa.Text + "," + txtCodMatricula.Text  + "," + Eval("num_sub_matric") + "," + txtDtIni.Text + "," + txtDtFim.Text  + "," + Eval("previsao_credito", "{0:dd/MM/yyyy}") %>' />
