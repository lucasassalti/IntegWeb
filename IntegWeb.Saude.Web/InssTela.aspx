<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="InssTela.aspx.cs" Inherits="IntegWeb.Saude.Web.InssTela" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upInss">
        <ContentTemplate>

            <asp:ValidationSummary ID="vsInss" runat="server" ForeColor="Red" ShowMessageBox="true"
                ShowSummary="false" />
            <div class="full_w">

                <div class="tabelaPagina">

                    <h1>Centro de Custo / INSS</h1>
                    <table>
                        <tr>
                    ...
                    <asp:GridView DataKeyNames="COD_EMPRS, COD_PLANO" OnRowCancelingEdit="grdInss_RowCancelingEdit" OnRowEditing="grdInss_RowEditing" OnRowUpdating="grdInss_RowUpdating" AllowPaging="true"
                        AutoGenerateColumns="False" EmptyDataText="A consulta não retornou registros" CssClass="Table" ClientIDMode="Static" ID="grdInss" runat="server" OnPageIndexChanging="grdInss_PageIndexChanging" PageSize="16">
                        <Columns>
