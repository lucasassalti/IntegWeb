...
namespace IntegWeb.Saude.Web.Relatorios.Cadastro {
    ...
    public class REV_ATIVO_CTEEP : ReportClass {
        
        public REV_ATIVO_CTEEP() {
        }
        
        public override string ResourceName {
            get {
                return "REV_ATIVO_CTEEP.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Saude.Web.Relatorios.Cadastro.REV_ATIVO_CTEEP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedREV_ATIVO_CTEEP : Component, ICachedReport {
        
        public CachedREV_ATIVO_CTEEP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            REV_ATIVO_CTEEP rpt = new REV_ATIVO_CTEEP();
            rpt.Site = this.Site;
            return rpt;
        }
