...
namespace IntegWeb.Saude.Web.Relatorios.Cadastro {
    ...
    public class ETQ_ATIVO_CTEEP : ReportClass {
        
        public ETQ_ATIVO_CTEEP() {
        }
        
        public override string ResourceName {
            get {
                return "ETQ_ATIVO_CTEEP.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Saude.Web.Relatorios.Cadastro.ETQ_ATIVO_CTEEP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedETQ_ATIVO_CTEEP : Component, ICachedReport {
        
        public CachedETQ_ATIVO_CTEEP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ETQ_ATIVO_CTEEP rpt = new ETQ_ATIVO_CTEEP();
            rpt.Site = this.Site;
            return rpt;
        }
