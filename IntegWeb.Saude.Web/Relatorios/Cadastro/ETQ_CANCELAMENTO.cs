...
namespace IntegWeb.Saude.Web.Relatorios.Cadastro {
    ...
    public class ETQ_CANCELAMENTO : ReportClass {
        
        public ETQ_CANCELAMENTO() {
        }
        
        public override string ResourceName {
            get {
                return "ETQ_CANCELAMENTO.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Saude.Web.Relatorios.Cadastro.ETQ_CANCELAMENTO.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedETQ_CANCELAMENTO : Component, ICachedReport {
        
        public CachedETQ_CANCELAMENTO() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ETQ_CANCELAMENTO rpt = new ETQ_CANCELAMENTO();
            rpt.Site = this.Site;
            return rpt;
        }
