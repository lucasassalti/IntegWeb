...
namespace IntegWeb.Saude.Web.Relatorios.Cadastro {
    ...
    public class ETQ_ATIVO_CPFL : ReportClass {
        
        public ETQ_ATIVO_CPFL() {
        }
        
        public override string ResourceName {
            get {
                return "ETQ_ATIVO_CPFL.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Saude.Web.Relatorios.Cadastro.ETQ_ATIVO_CPFL.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedETQ_ATIVO_CPFL : Component, ICachedReport {
        
        public CachedETQ_ATIVO_CPFL() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ETQ_ATIVO_CPFL rpt = new ETQ_ATIVO_CPFL();
            rpt.Site = this.Site;
            return rpt;
        }
