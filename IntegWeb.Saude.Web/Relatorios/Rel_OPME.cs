...
namespace IntegWeb.Saude.Web.Relatorios {
    ...
    public class Rel_OPME : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Saude.Web.Relatorios.Rel_OPME.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRel_OPME : Component, ICachedReport {
        
        public CachedRel_OPME() {
        }
