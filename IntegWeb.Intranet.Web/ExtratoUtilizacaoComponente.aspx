<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Popup.Master" CodeBehind="ExtratoUtilizacaoComponente.aspx.cs" Inherits="IntegWeb.Intranet.Web.ExtUtilizacaoComponente" %>
                ...
                <div class="full_w">
                    ...
                    <div class="tabelaPagina">
                        ...
                        <asp:GridView ID="grdExtratoUtilizacao" runat="server"
                            ...
                            OnPageIndexChanging="grdExtratoUtilizacao_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="valorTotal" HeaderText="Total dos Serviços" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" />
                                <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="btDetalhes" CausesValidation="false" CssClass="button" runat="server" Text="Visualizar" CommandName="Visualizar" CommandArgument='<%# txtCodEmpresa.Text + "," + txtCodMatricula.Text + "," + ddlRepresentante.SelectedValue + "," +  Eval("NUM_SUB_MATRIC") + "," +  ddlSemestre.SelectedValue + "," +  ddlNumAno.SelectedValue.ToString() %>' />
