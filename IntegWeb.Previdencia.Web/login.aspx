<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="IntegWeb.Previdencia.Web.login" %>
            ...
            <div id="main">
                <div class="full_w">
                    <form id="Form1" runat="server">
                      <center><img src="img/bg_logo.png" style="height: 78px; width: 93px;" /><br /><h2>PrevWeb</h2></center>  
                        <%--<h1 class="tituloLogin">PrevWeb</h1>--%>
