...
{
    public partial class intP_CadAssociacaoVerba : BasePage
    {
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            if (ddlPesqAssociado.SelectedValue=="" &&
                ddlPesqVerba.SelectedValue=="")
            {
        ...
        {
            ddlPesqAssociado.SelectedValue = "";
            ddlPesqVerba.SelectedValue = "";
            grdCCusto.EditIndex = -1;
            grdCCusto.PageIndex = 0;
            CarregarTela();
        ...
        private void CarregaDrop()
        {
            ...
            short.TryParse(ddlPesqAssociado.Text, out sPesqEmpresa);

            CCustoBLL obj = new CCustoBLL();
            CarregaDropDowList(ddlPesqVerba, obj.GetAssociados(sPesqEmpresa).ToList<object>(), "DCR_ORGAO", "NUM_ORGAO");
            ListItem SELECIONE = ddlPesqVerba.Items.FindByValue("0");
            CloneDropDownList(ddlPesqVerba, ddlNumOrgao);
