...
namespace IntegWeb.Previdencia.Web.Relatorios {
    ...
    public class Rel_SemTpAnt : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Previdencia.Web.Relatorios.Rel_SemTpAnt.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRel_SemTpAnt : Component, ICachedReport {
        
        public CachedRel_SemTpAnt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rel_SemTpAnt rpt = new Rel_SemTpAnt();
            rpt.Site = this.Site;
            return rpt;
        }
