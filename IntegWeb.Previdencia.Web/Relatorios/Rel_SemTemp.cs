...
namespace IntegWeb.Previdencia.Web.Relatorios {
    ...
    public class Rel_SemTemp : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Previdencia.Web.Relatorios.Rel_SemTemp.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRel_SemTemp : Component, ICachedReport {
        
        public CachedRel_SemTemp() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rel_SemTemp rpt = new Rel_SemTemp();
            rpt.Site = this.Site;
            return rpt;
        }
