...
namespace IntegWeb.Previdencia.Web.Relatorios {
    ...
    public class Rel_TempPlano : ReportClass {
        
        public Rel_TempPlano() {
        }
        
        public override string ResourceName {
            get {
                return "Rel_TempPlano.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Previdencia.Web.Relatorios.Rel_TempPlano.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRel_TempPlano : Component, ICachedReport {
        
        public CachedRel_TempPlano() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rel_TempPlano rpt = new Rel_TempPlano();
            rpt.Site = this.Site;
            return rpt;
        }
