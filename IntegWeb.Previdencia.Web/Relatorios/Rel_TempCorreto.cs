...
namespace IntegWeb.Previdencia.Web.Relatorios {
    ...
    public class Rel_TempCorreto : ReportClass {
        
        public Rel_TempCorreto() {
        }
        
        public override string ResourceName {
            get {
                return "Rel_TempCorreto.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "IntegWeb.Previdencia.Web.Relatorios.Rel_TempCorreto.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRel_TempCorreto : Component, ICachedReport {
        
        public CachedRel_TempCorreto() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rel_TempCorreto rpt = new Rel_TempCorreto();
            rpt.Site = this.Site;
            return rpt;
        }
