<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="BeneficiarioTipo.aspx.cs" Inherits="IntegWeb.Previdencia.Web.BeneficiarioTipo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="full_w">

        <div class="h_title">
        </div>
        <h1>Tipo de Beneficiário</h1>
        <asp:UpdatePanel runat="server" ID="upPanel">
            <ContentTemplate>
                 <div id="divBenef" class="tabelaPagina">
                        <table>
                            <tr>
                                <td>Digite o Tipo de Beneficiário</td>
                                <td>
                                    <asp:TextBox ID="txtBenef" runat="server" Width ="500"></asp:TextBox>
                                 </td>
                                <td>
                        ...
                        <asp:GridView  DataKeyNames="ID_TPBENEFICIO" OnRowCancelingEdit="grd_RowCancelingEdit" OnRowDeleting="grd_RowDeleting" OnRowEditing="grd_RowEditing"  OnRowUpdating="grd_RowUpdating" AllowPaging="true"
                             AutoGenerateColumns="False" EmptyDataText="A consulta não retornou registros" CssClass="Table" ClientIDMode="Static" ID="grd"  runat="server" OnPageIndexChanging="grd_PageIndexChanging" PageSize="10">
                                <Columns>
                                   <asp:TemplateField HeaderText="Tipo de Beneficiário" >
                                    <EditItemTemplate>
