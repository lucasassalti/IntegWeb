<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AcertoDemonstrativo.aspx.cs" Inherits="IntegWeb.Previdencia.Web.AcertoDemonstrativo" SmartNavigation ="true" %>
                                            ...
                                            <asp:Panel runat="server" ID="pnlNovoLancamento" Visible="false" class="tabelaPagina">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><asp:Label ID="lblTipo" runat="server" Text='' Width="40px" ReadOnly="true"></asp:Label></td>
                                                ...
                                                <asp:GridView ID="grdReembolsoAjustes" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Tipo" SortExpression="TIP_CRED_DEB">
                                                            <ItemTemplate>
                                                                <div>
                                                                    <asp:Label ID="lblTipo" runat="server" Text='<%# Eval("TIP_CRED_DEB") %>'></asp:Label>
                                                                </div>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
...
<%--                                                        <asp:TemplateField HeaderText="Acerto" SortExpression="VLR_ACERTO">
                                                        ...
                                                        <asp:TemplateField HeaderText="">
                                                            <ItemTemplate>
                                                                <div>
                                                                    <asp:ImageButton ID="btAlterar" runat="server" Text="Alterar" CommandName="Edit" CommandArgument='<%# Eval("COD_DEMO_DET") %>' ImageUrl="~/img/i_edit.png" Width="16px" Height="16px" AlternateText="Alterar" ToolTip="Alterar" Visible='<%# (Eval("DTH_IMPORTADO")==null) %>' />&nbsp;
                                                                    <asp:ImageButton ID="btExcluir" runat="server" Text="Excluir" CommandName="Excluir" CommandArgument='<%# Eval("COD_DEMO_DET") %>' ImageUrl="~/img/i_delete.png" Width="16px" Height="16px" AlternateText="Excluir" ToolTip="Excluir" OnClientClick='return btExcluir_click(this);' Visible='<%# (Eval("DTH_IMPORTADO")==null) %>' />&nbsp;
                                                                </div>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <div>
