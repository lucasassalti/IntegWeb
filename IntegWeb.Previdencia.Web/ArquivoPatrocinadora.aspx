<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ArquivoPatrocinadora.aspx.cs" Inherits="IntegWeb.Previdencia.Web.ArquivoPatrocinadora" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function pergunta_sobrepor(lista) {
            ...
            var r = confirm('Os seguintes arquivos já constam na lista de uploads:\\n\\n' + lista + '\\n\\nDeseja sobrepor todos?');
            if (r == true) {
    ...
    <div class="full_w">
        ...
        <h1>Validador de Arquivos das Patrocinadoras</h1>
                                    ...
                                    <table>
                                        <tr>
                                            <td colspan="4">
                                                ...
                                                <asp:Button ID="btnDemonstrativo" CssClass="button" runat="server" Text="Demonstrativo" OnClientClick="return btnDemonstrativo_click();" disabled="disabled"/>
                                                ...
                                                <asp:Button ID="btnSubmit_ajustes" CssClass="button" runat="server" Text="Ajustes" OnClick="btnAjustes_Click" Style="display: none;" />
                                            </td>
                                            <td>
                                                <div class="dialog-message-confirm" title="Carregar dados / Demonstrativo" id="pnl_carga" style="display: none;">
                                                    <p>
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label6" runat="server" Text="Processamento imediato:"></asp:Label>
                                                                </td>
                                                                <td>
                                                                     <asp:CheckBox ID="chkImediato" runat="server" Checked="false" Text="&nbsp" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </p>
                                            ...
                                            <td rowspan="2" style="text-align: center; height: 10px;">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Emps.">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="btNotaDebito" CssClass="button btDemo" runat="server" Text="Nota de Débito" CommandName="NotaDebito" CommandArgument='<%# Eval("COD_ARQ_PAT").ToString() + "," + Eval("ANO_REF").ToString() + "," + Eval("MES_REF").ToString() + "," + Eval("GRUPO_PORTAL").ToString() %>' ImageUrl="~/img/financial.png" Width="12px" Height="12px" Visible='<%# (short.Parse(Eval("TIP_ARQUIVO").ToString())==4) && (int.Parse(Eval("COD_STATUS").ToString()) > 7) %>' ToolTip="Nota de Débito" />
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
