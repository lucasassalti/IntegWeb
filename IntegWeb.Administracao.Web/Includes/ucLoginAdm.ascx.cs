...
namespace IntegWeb.Administracao.Web.Includes
{
    public partial class ucLoginAdm : System.Web.UI.UserControl
    {
        #region Atributos
        ...
        protected void btnAcessar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(objBLL.senha))
            {
                ...
                if (objBLL.AutenticaUsuarioAD())
                {
                    ...
                    MontaMenu();
                    //Util.Log("SUCESSO NO LOGIN", "login: " + objBLL.login + " senha: " + objBLL.senha + " nome: " + objBLL.nome + " departamento: " + objBLL.departamento);
                ...
                else
                {
                    ...
                    //Util.Log("FALHA NO LOGIN " + cont, "login: " + objBLL.login + " senha: " + objBLL.senha + " nome: " + objBLL.nome + " departamento: " + objBLL.departamento);
                    if (cont < 3)
                    {
                        cont = 3 - cont;
